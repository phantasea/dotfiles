...
HISTIGNORE="epub*:cd*:ls*:ll*:l *:a *:f:fm:fe:m:mus:e *:g *:tig:t:w:x:ww:em:j *:ce:cu:cw:cn:ca:cat*:mm:ff:gd:gs:gpi:gpo:gci*:sda:sdt*:man*:shut:make:smi:extract*:acv*:vc*:audcut*:ac *"
...
export PATH="/opt/util:/opt/util/bins:/opt/util/misc:$PATH"
